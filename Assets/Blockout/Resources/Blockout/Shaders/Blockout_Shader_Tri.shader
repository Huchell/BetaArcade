...
////// Specular:
                ...
                float3 diffuseColor = saturate(((_Color.rgb*((node_39*_node_5907.rgb)+(node_3474*_node_4242.rgb)+(node_9210*_node_5544.rgb)))+(((node_39*_node_5907.a)+(node_3474*_node_4242.a)+(node_9210*_node_5544.a))*_Drop_Value))); // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float2 node_9497 = float2(i.posWorld.r,i.posWorld.g);
                float4 _node_5544 = tex2D(_Texture,TRANSFORM_TEX(node_9497, _Texture));
                float3 diffColor = saturate(((_Color.rgb*((node_39*_node_5907.rgb)+(node_3474*_node_4242.rgb)+(node_9210*_node_5544.rgb)))+(((node_39*_node_5907.a)+(node_3474*_node_4242.a)+(node_9210*_node_5544.a))*_Drop_Value)));
                float specularMonochrome;
                float3 specColor;
